...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        updateTableData(alunos);

    }

    public void updateTableData(List<Aluno> alunos) {
        ...
        model = new DefaultTableModel(
            ...
            // Data de nasc, cpf e IMC desabilitados de edição
            @Override
            public boolean isCellEditable(int row, int column) {
                return column != 5 && column != 2 && column != 1;
            }
        };
    ...
    private void initComponents() {
        ...
        buscarAlunoCampo = new javax.swing.JTextField();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class[] {
                    java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.Float.class,
        ...
        buscarAlunoCampo.setToolTipText("Buscar aluno");
        buscarAlunoCampo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buscarAlunoCampoActionPerformed(evt);
            }
        });
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(progress, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                203, Short.MAX_VALUE))
                                                .addGap(127, 127, 127)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(jScrollPane1,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE, 826,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addGroup(layout.createSequentialGroup()
                                                                .addComponent(buscarAlunoCampo,
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(titulo, javax.swing.GroupLayout.PREFERRED_SIZE, 39,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(4, 4, 4)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(buscarAlunoCampo, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void imcButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_imcButtonActionPerformed
        ...
        if (linha == -1) {
            ...
            String desktopPath = System.getProperty("user.home") + "/Fatec/imcLP";
            ...
            try (PrintWriter writer = new PrintWriter(filePath)) {
                ...
                JOptionPane.showMessageDialog(null,
                        "IMC do aluno(a) " + nome + " Salvo com sucesso! em:" + "Fatec/imcLP");
    ...
    private void buscarAlunoCampoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buscarAlunoCampoActionPerformed
    }// GEN-LAST:event_buscarAlunoCampoActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        // Buscar Aluno 
        String nome = buscarAlunoCampo.getText();
        AlunoDAO alunoDAO = new AlunoDAO();
        List<Aluno> alunos = alunoDAO.pesquisarAluno(nome);
        updateTableData(alunos);
    ...
    private javax.swing.JTextField buscarAlunoCampo;
